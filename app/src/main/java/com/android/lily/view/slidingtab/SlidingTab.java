...
public class SlidingTab extends HorizontalScrollView {
    ...
    private void addTab(final int position, View tab, View tab2) {
        ...
        SlidingTabItem tabItem = new SlidingTabItem(getContext());
        tabItem.addView(tab, 0, matchParentTabLayoutParams);
        tabItem.addView(tab2, 1, matchParentTabLayoutParams);
        tabsContainer.addView(tabItem, position, shouldExpand ? expandedTabLayoutParams : defaultTabLayoutParams);

        tabItem.setDoubleSingleClickListener(new SlidingTabItem.DoubleSingleClickListener() {
            @Override
...
//        canvas.drawRect(0, height - underlineHeight, tabsContainer.getWidth(), height, indicatorPaint);
        ...
        // TODO: 17/5/12 暂时注释
//        if (indicatorWrap){
//            canvas.drawRect(lineLeft+tabPadding, height - indicatorHeight, lineRight-tabPadding, height, indicatorPaint);
//        }else{
//            canvas.drawRect(lineLeft+tabPadding, height - indicatorHeight, lineRight-tabPadding, height, indicatorPaint);
//        }
